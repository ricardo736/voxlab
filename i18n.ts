...
export const translations = {
  en: {
    ...
    compressorGainDesc: 'Compressor & Gain',
    frequencySeparation: 'Frequency Separation',
    pianoVoiceSplitDesc: 'Piano/Voice Split',
    noiseGateLabel: 'Noise Gate',
    pitchSensitivityLabel: 'Pitch Sensitivity',
    customAudioLabel: 'Custom Audio',
    loadLocalSamples: 'Load Local Samples',
    selectAudioFilesHelper: 'Select audio files (mp3/wav/flac)',
    noSamplesFound: 'No recognized samples found.',
    smartPitchShifting: 'Smart Pitch Shifting Active',
    failedCount: '{count} failed',
    faq: 'FAQ',
    support: 'Support',

    // Paywall
    voxlabPro: 'VoxLab Pro',
    unlockFullPotential: 'Unlock Your Full Potential',
    accessAllFeatures: 'Access all exercises, routines, and AI-powered training.',
    feature30Exercises: '30+ vocal exercises',
    feature10Routines: 'All 10 training routines',
    featureAIGeneration: 'AI exercise generation',
    featureRangeDetection: 'Vocal range detection',
    feature5FreeExercises: '5 free exercises',
    feature2Routines: '2 warmup routines',
    freeLabel: 'free',
    save40: 'Save 40%',
    annual: 'Annual',
    monthly: 'Monthly',
    annualPrice: '$3.99',
    perMonth: '/mo',
    annualBilled: '$47.99 billed yearly',
    monthlyPrice: '$6.99',
    billedMonthly: 'Billed monthly',
    startAnnualPlan: 'Start Annual Plan',
    ...
    subscriptionDisclaimer: 'Subscriptions auto-renew. Cancel anytime in your App Store settings.',
    ...
    // AI Studio - Exercise Result
    instructionsHeader: 'Instructions',
    notesHeader: 'Notes',
    patternHeader: 'Pattern',
    notesCount: '{count} notes',
    noPatternDefined: 'No pattern defined',
    noteDuration: 'Note Duration',
    beatsUnit: 'beats',
    tempoHeader: 'Tempo',
    beatsPerMinute: 'Beats per minute',
    stopPreviewFull: 'Stop Preview',
    aiGenerateError: 'An error occurred while generating the exercise. Please try again.',
    aiRefineError: 'An error occurred while refining the exercise. Please try again.',
  },
  'pt-BR': {
    // General
    home: 'Início',
    ...
    compressorGainDesc: 'Compressor e Ganho',
    frequencySeparation: 'Separação de Frequência',
    pianoVoiceSplitDesc: 'Separação Piano/Voz',
    noiseGateLabel: 'Redutor de Ruído',
    pitchSensitivityLabel: 'Sensibilidade de Tom',
    customAudioLabel: 'Áudio Personalizado',
    loadLocalSamples: 'Carregar Amostras Locais',
    selectAudioFilesHelper: 'Selecione arquivos de áudio (mp3/wav/flac)',
    noSamplesFound: 'Nenhuma amostra reconhecida.',
    smartPitchShifting: 'Transposição Inteligente Ativa',
    ...
    // Paywall
    voxlabPro: 'VoxLab Pro',
    unlockFullPotential: 'Libere Todo Seu Potencial',
    accessAllFeatures: 'Acesse todos os exercícios, rotinas e treino com IA.',
    feature30Exercises: '30+ exercícios vocais',
    feature10Routines: 'Todas as 10 rotinas de treino',
    featureAIGeneration: 'Geração de exercícios com IA',
    featureRangeDetection: 'Detecção de extensão vocal',
    feature5FreeExercises: '5 exercícios gratuitos',
    feature2Routines: '2 rotinas de aquecimento',
    freeLabel: 'grátis',
    save40: 'Economize 40%',
    annual: 'Anual',
    monthly: 'Mensal',
    annualPrice: 'R$19,90',
    perMonth: '/mês',
    annualBilled: 'R$239,90 cobrado anualmente',
    monthlyPrice: 'R$34,90',
    billedMonthly: 'Cobrado mensalmente',
    startAnnualPlan: 'Assinar Plano Anual',
    startMonthlyPlan: 'Assinar Plano Mensal',
    ...
    subscriptionDisclaimer: 'Assinaturas renovam automaticamente. Cancele a qualquer momento nas configurações da App Store.',
    ...
    notesHeader: 'Notas',
    patternHeader: 'Padrão',
    notesCount: '{count} notas',
    noPatternDefined: 'Nenhum padrão definido',
    noteDuration: 'Duração da Nota',
    beatsUnit: 'tempos',
    tempoHeader: 'Andamento',
    beatsPerMinute: 'Batidas por minuto',
    stopPreviewFull: 'Parar Prévia',
    aiGenerateError: 'Ocorreu um erro ao gerar o exercício. Por favor, tente novamente.',
    aiRefineError: 'Ocorreu um erro ao refinar o exercício. Por favor, tente novamente.',
  }
};
