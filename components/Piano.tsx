...
import { Note, VocalRange, Theme } from '../types';
...
const Piano: React.FC<PianoProps> = ({ notes, onKeyClick, vocalRange, currentTheme }) => {
    ...
    return (
        <div className={`relative w-full group my-6 mx-auto`}>
            ...
            >
                <svg className="w-5 h-5 text-slate-700 dark:text-slate-300" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg>
            </button>
            <button
            ...
            >
                <svg className="w-5 h-5 text-slate-700 dark:text-slate-300" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
            </button>

            <div className={`relative w-full bg-white/20 dark:bg-black/20 backdrop-blur-lg p-2 sm:p-4 rounded-full shadow-[0_12px_30px_-12px_rgba(0,0,0,0.2),inset_-1px_1px_8px_rgba(0,0,0,0.08),inset_2px_-2px_4px_rgba(255,255,255,0.5)] dark:shadow-[0_12px_30px_-12px_rgba(0,0,0,0.5),inset_-1px_1px_8px_rgba(255,255,255,0.08),inset_2px_-2px_4px_rgba(0,0,0,0.5)] border border-slate-300/60 dark:border-slate-700/60`}>
